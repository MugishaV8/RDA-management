...
<div class="content-body">
    ...
    <div class="container-fluid" align="center">
        <div class="row">
            ...
            <img class="wow bounceIn" data-wow-delay="1.4s" src="http://rwandadiabetes.com/wp-content/uploads/2015/12/IMG_1716.jpg" height="800" alt="Services"/>
        </div>
    <div id="about-wrap">
        <div>
            <h2 class="boxtitle wow bounceInLeft" data-wow-delay="0.1s">About Us</h2>
            <p class="text wow bounceInRight" data-wow-delay="0.2s">Diabetes is a major challenge for health and development in the 21st century. This chronic and incurable disease is largely preventable but remains responsible for millions of deaths every year and many more life-threatening complications. No country, rich or poor, is immune to the epidemic. According to the Diabetes Atlas, the prevalence in Rwanda is about 3.2% of the population.
RDA is a  non-governmental organization that was founded in 1997 with the mission of promoting diabetes care, preventing and curing diabetes in Rwanda, supporting diabetics and their families and joining the global efforts to advocate for diabetic people.  </p>
        </div>
    </div>
</div>
        </div>
