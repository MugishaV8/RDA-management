...
<div class="nk-sidebar">           
    <div class="nk-nav-scroll">
        <ul class="metismenu" id="menu">
            ...
            ?>
            <li>
                <a href="patient" aria-expanded="false">
                    <i class="fa fa-wheelchair"></i><span class="nav-text">Patients</span>
                </a>
            </li>
            <?php } ?>
            <li>
            ...
            <li>
                <a href="users" aria-expanded="false">
                    <i class="fa fa-users"></i><span class="nav-text">System users</span>
                </a>
            </li>
            <?php } ?>
        </ul>
